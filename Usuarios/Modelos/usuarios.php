...
class Usuarios extends conexion
{
	...
	{
		$row = null;
		$statement =$this->db->prepare("SELECT * FROM usuarios WHERE Perfilu='Usuarios'");
		$statement->execute();
	...
	{
		$row = null;
		$statement=$this->db->prepare("SELECT * FROM usuarios WHERE Perfilu='Usuarios' AND id_usuario=:Id");
